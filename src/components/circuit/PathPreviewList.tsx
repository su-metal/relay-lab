  ...
  return (
    <section className={styles.panel} aria-label="経路確認">
      ...
      {/*
        ...
        **「動かしていない状態の結果」だと言い切る。** ここに出ている励磁を
        「ボタンを押した後の姿」と読まれると、押して初めて動く回路が
        壊れているように見える
      */}
      <p className={styles.scope}>
        どのスイッチも操作していない状態で、電源から電位が届いている範囲を
        塗っています。押した後どうなるかは ▶ で確認してください。
      </p>

      {preview.activeLoadCount > 0 && (
        <p className={styles.active}>
          この状態のまま励磁・点灯する負荷が {preview.activeLoadCount} 個あります。
        </p>
      )}
