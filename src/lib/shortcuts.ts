...
export const SHORTCUT_GROUPS: readonly ShortcutGroup[] = [
  {
    ...
    rows: [
       ...
       */
      {
        ...
        note: "左 / 左右中央 / 右 / 上 / 上下中央 / 下 と、左右・上下の均等。部品を 2 個以上（均等は 3 個以上）選んでから押す。基準になる両端の部品は動かない",
      },
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        note: "どのスイッチも操作していない状態で、電源から電位が届いている線を破線で塗り、止まっている接点を右の一覧に端子番号で出す。押した後どうなるかは ▶ で確認する",
      },
    ],
  },
  {
